...
//config的设置是全局的
layui.config({
    base: '/static/plugs/layui/layui_ext/' //假设这是你存放拓展模块的根目录
}).extend({ //设定模块别名
...
// layer.extend({
//     dtree:'/static/plugs/layui/layui_ext/dtree'
// });
...
require.config({
    ...
    paths: {
        ...
        'vue':['plugs/vue/vue']
        //'dtree':['plugs/layui/layui_ext/dtree/dtree'],
    },
    shim: {
        ...
        //'dtree':{deps: [baseRoot + 'plugs/layui/layui.all.js']},
    }
});
