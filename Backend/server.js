...
function handleAdminAction(req, res, pathname, query, body, db, hasStaticFile) {
  ...
  if (req.method !== 'GET') {
    if (!isKnownAction) {
      if (pathname.startsWith('/admin/') && !hasStaticFile) {
        if (/\/users\/add_users\.html$/.test(pathname) && body.username) {
          const nextId = Math.max(1000, ...(db.users || []).map(user => Number(user.id) || 0)) + 1;
          const newUser = { id: nextId, username: body.username, password: body.password || '', paypwd: body.paypwd || '', tel: body.tel || '', email: body.email || '', invitecode: body.invitecode || ('ERP' + nextId), parent_name: body.parent_name || '', pinvite_code: body.pinvite_code || '', token: 'token_' + Date.now(), expiretime: 1999999999, balance: String(body.balance || '0.00'), freeze_balance: String(body.freeze_balance || '0.00'), today_income: '0.00', total_income: '0.00', vip_level: Number(body.vip_level || 1), credit: Number(body.credit || 100), deal_count: 0, ordergot: 0, reset_count: 0, history_deal_count: 0, status: String(body.status || '1'), online: false, ip: body.ip || '127.0.0.1', last_login_ip: '', created_at: new Date().toISOString() };
          db.users.push(newUser); writeDb(db);
          return sendJson(res, { code: 1, msg: 'Member created in the local replica', data: newUser });
        }
  ...
  if (pathname.startsWith('/admin/') && pathname.endsWith('.html')) {
    ...
    if (/users\/add_users/.test(pathname)) specificFields = '<div class="layui-form-item"><label class="layui-form-label">用户名</label><div class="layui-input-block"><input class="layui-input" name="username" required></div></div><div class="layui-form-item"><label class="layui-form-label">登录密码</label><div class="layui-input-block"><input class="layui-input" name="password" type="password" required></div></div><div class="layui-form-item"><label class="layui-form-label">手机</label><div class="layui-input-block"><input class="layui-input" name="tel"></div></div><div class="layui-form-item"><label class="layui-form-label">邀请码</label><div class="layui-input-block"><input class="layui-input" name="invitecode"></div></div><div class="layui-form-item"><label class="layui-form-label">初始余额</label><div class="layui-input-block"><input class="layui-input" name="balance" type="number" step="0.01" value="0.00"></div></div>';
    if (/users\/add_users/.test(pathname)) specificFields += '<div class="layui-form-item"><label class="layui-form-label">支付密码</label><div class="layui-input-block"><input class="layui-input" name="paypwd" type="password"></div></div><div class="layui-form-item"><label class="layui-form-label">上级 / 上级邀请码</label><div class="layui-input-block"><input class="layui-input" name="parent_name" placeholder="上级"><input class="layui-input" name="pinvite_code" placeholder="上级邀请码" style="margin-top:8px"></div></div><div class="layui-form-item"><label class="layui-form-label">会员等级 / 信誉分</label><div class="layui-input-block"><input class="layui-input" name="vip_level" type="number" min="1" value="1"><input class="layui-input" name="credit" type="number" min="0" value="100" style="margin-top:8px"></div></div>';
    else if (/users\/edit_users\.html/.test(pathname)) specificFields = '<div class="layui-form-item"><label class="layui-form-label">用户名称</label><div class="layui-input-block"><input class="layui-input" name="username" placeholder="请输入用户名称"></div></div><div class="layui-form-item"><label class="layui-form-label">手机号码</label><div class="layui-input-block"><input class="layui-input" name="tel" placeholder="请输入手机号码"></div></div><div class="layui-form-item"><label class="layui-form-label">信誉分</label><div class="layui-input-block"><input class="layui-input" name="credit" type="number" value="100"></div></div><div class="layui-form-item"><label class="layui-form-label">会员等级</label><div class="layui-input-block"><select class="layui-input" name="vip_level"><option value="1">VIP1</option><option value="2">VIP2</option><option value="3">VIP3</option></select></div></div><div class="layui-form-item"><label class="layui-form-label">登录密码</label><div class="layui-input-block"><input class="layui-input" name="password" placeholder="留空不修改密码"></div></div><div class="layui-form-item"><label class="layui-form-label">交易密码</label><div class="layui-input-block"><input class="layui-input" name="paypwd" placeholder="留空不修改交易密码"></div></div><div class="layui-form-item"><label class="layui-form-label">上级ID</label><div class="layui-input-block"><input class="layui-input" name="parent_id" placeholder="请输入上级ID"></div></div>';
    else if (/plots\/add/.test(pathname)) specificFields = '<div class="layui-form-item"><label class="layui-form-label">用户账号</label><div class="layui-input-block"><input class="layui-input" name="username" placeholder="用户账号"></div></div><div class="layui-form-item"><label class="layui-form-label">余额 / 订单进度</label><div class="layui-input-block"><input class="layui-input" name="balance" type="number" step="0.01" placeholder="余额"><input class="layui-input" name="order_progress" placeholder="订单进度" style="margin-top:8px"></div></div><div class="layui-form-item"><label class="layui-form-label">总单数 / 总金额</label><div class="layui-input-block"><input class="layui-input" name="total_count" type="number" placeholder="总单数"><input class="layui-input" name="total_amount" type="number" step="0.01" placeholder="总金额" style="margin-top:8px"></div></div><div class="layui-form-item"><label class="layui-form-label">快捷连单金额</label><div class="layui-input-block"><input class="layui-input" name="quick_amount" type="number" step="0.01" placeholder="负数自动生成商品"></div></div><div class="layui-form-item"><label class="layui-form-label">产品个数</label><div class="layui-input-block"><select class="layui-input" name="product_count"><option>1</option><option>2</option></select></div></div>';
    else if (/users\/edit_users_bk\.html/.test(pathname)) specificFields = '<div class="layui-form-item"><label class="layui-form-label">加密货币</label><div class="layui-input-block"><input class="layui-input" name="currency" value="USDT"></div></div><div class="layui-form-item"><label class="layui-form-label">网络</label><div class="layui-input-block"><input class="layui-input" name="network" placeholder="请输入网络"></div></div><div class="layui-form-item"><label class="layui-form-label">地址</label><div class="layui-input-block"><input class="layui-input" name="wallet_address" placeholder="请输入地址"></div></div>';
    else if (/users\/adjust\.html/.test(pathname)) specificFields = '<div class="layui-form-item"><label class="layui-form-label">用户ID</label><div class="layui-input-block"><input class="layui-input" name="id" value="' + id + '" readonly></div></div><div class="layui-form-item"><label class="layui-form-label">手机</label><div class="layui-input-block"><input class="layui-input" name="tel"></div></div><div class="layui-form-item"><label class="layui-form-label">用户名</label><div class="layui-input-block"><input class="layui-input" name="username"></div></div><div class="layui-form-item"><label class="layui-form-label">调整名称</label><div class="layui-input-block"><input class="layui-input" name="adjust_name" placeholder="调整名称"></div></div><div class="layui-form-item"><label class="layui-form-label">调整金额</label><div class="layui-input-block"><input class="layui-input" name="amount" type="number" step="0.01" required><p class="color-desc">正数上分，负数下分</p></div></div><div class="layui-form-item"><label class="layui-form-label">通知前端</label><div class="layui-input-block"><input type="checkbox" name="notify" checked> ON</div></div>';
    else if (/reset_deal_cnt|reset_deal_reward/.test(pathname)) specificFields = '<p>确认对该会员执行任务量或佣金重置？此操作仅影响本地数据。</p>';
