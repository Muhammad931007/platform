...
function localMemberPage(db, query) {
  ...
  html = html.replace(/<head([^>]*)>/i, `<head$1><style>.local-fixture-row{background:#fff!important}.local-fixture-row>td{vertical-align:top!important;padding:15px!important;line-height:1.75;white-space:normal;color:#666;border:1px solid #e6e6e6}.local-fixture-row>td:nth-child(1){width:170px;min-width:170px}.local-fixture-row>td:nth-child(2){width:155px;min-width:155px}.local-fixture-row>td:nth-child(3){width:345px;min-width:345px}.local-fixture-row>td:nth-child(4){width:185px;min-width:185px}.local-fixture-row>td:nth-child(5){width:180px;min-width:180px}.local-fixture-row>td:nth-child(6){width:195px;min-width:195px}.local-fixture-row>td:nth-child(7){width:400px;min-width:400px}.local-fixture-row .local-action{display:inline-block!important;margin:5px 4px 0 0!important;line-height:28px!important;padding:0 10px!important;border-radius:2px!important}</style>`);
